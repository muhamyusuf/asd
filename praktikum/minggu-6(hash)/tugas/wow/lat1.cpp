...
int main()
{
    ...
    insertByModFunc(HashTable, "apel");
    insertByModFunc(HashTable, "pisang");
    insertByModFunc(HashTable, "alpukat");
    insertByModFunc(HashTable, "duren");
    ...
    insertFirst(&First(HashTable, 2), "lengkeng");

    insertLast(&First(HashTable, 0), "anggur");
